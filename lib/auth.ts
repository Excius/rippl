...
// NOTE: Can't use database sessions because prisma adapter makes middleware size more than 1 MB, which is not available in Vercel Edge Functions(Free Tier).
